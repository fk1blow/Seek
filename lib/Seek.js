...
var Logger = Packagr.from('Logging').load('Log');
...
var Seek = Klass({
	methods: {
		initialize: function() {
      Logger.debug("=> Booting Seek");
      Logger.debug("=> node.js 2.3.10 application starting on http://0.0.0.0:3000");
      Logger.debug("=> Ctrl-C to shutdown server");
