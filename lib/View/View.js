	...
	methods: {
		...
		_render: function() {
			...
			//if(has_what && has_layout == false) {
				this._sendToResponse(this.renderString(this.what), this.content_type)
				//return true;
			//}
		...
		_sendToResponse: function(response, ctype) {
			Response.sendToBody(response, ctype);
		},
